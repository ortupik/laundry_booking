...
<div id="lda-payments" class="panel tab-content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h1 class="panel-title"><?php echo filter_var($label_language_values['payments_history_details'], FILTER_SANITIZE_STRING);	?></h1>
        </div>
		<ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab" href="#client-payments"><?php echo filter_var($label_language_values['client_payments'], FILTER_SANITIZE_STRING);	?></a></li>
			<li><a data-toggle="tab" href="#staff-payments"><?php echo filter_var($label_language_values['staff_payments'], FILTER_SANITIZE_STRING);	?></a></li>
		</ul>
			...
			<div id="accordion" class="panel-group">
                <form id="" name="" class="" method="post">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 col-lg-4">
						<label><?php echo filter_var($label_language_values['select_payment_option_export_details'], FILTER_SANITIZE_STRING);	?></label>
					...
					<div class="col-md-2 col-sm-2 col-xs-12 col-lg-2">
						<br />
						<button type="button" class="btn btn-info mb-10 mybtngetpaymentdate" name=""><?php echo filter_var($label_language_values['submit'], FILTER_SANITIZE_STRING);	?></button>
					</div>
				...
				<table id="payments-details" class="display responsive nowrap table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tr>
						...
						<th><?php echo filter_var($label_language_values['transaction_id'], FILTER_SANITIZE_STRING);	?></th>
						...
						<th><?php echo filter_var($label_language_values['discount'], FILTER_SANITIZE_STRING);	?></th>
						<th><?php echo filter_var($label_language_values['tax'], FILTER_SANITIZE_STRING);	?></th>
						<th><?php echo filter_var($label_language_values['net_total'], FILTER_SANITIZE_STRING);	?></th>
						<th><?php echo filter_var($label_language_values['partial_amount'], FILTER_SANITIZE_STRING);	?></th>
					...
					while($rs = mysqli_fetch_array($r)){
						?>
						<tr>
							<td><?php echo filter_var($rs['order_id'], FILTER_SANITIZE_STRING);	?></td>
							<td>
								<?php 
								$p_client_name = $objpayment->getclientname($rs['order_id']);
								echo filter_var($p_client_name, FILTER_SANITIZE_STRING);
								?>
							</td>
							<?php 
							if($rs['net_amount']==0){
								...
								<td><?php 						
									...
									{ 			
										echo filter_var($label_language_values[str_replace(" ", "_", strtolower($rs['payment_method']))], FILTER_SANITIZE_STRING);
									} ?>					
								</td>
								...
								<td><?php if($rs['discount'] == 0){ echo filter_var($label_language_values['free'], FILTER_SANITIZE_STRING); }else{echo filter_var( $general->ld_price_format($rs['discount'], FILTER_SANITIZE_STRING),$symbol_position,$decimal);}?></td>
								<td><?php if($rs['taxes'] == 0){ echo filter_var($label_language_values['free'], FILTER_SANITIZE_STRING); }else{echo  filter_var($general->ld_price_format($rs['taxes'], FILTER_SANITIZE_STRING),$symbol_position,$decimal);}?></td>
								<td><?php if($rs['net_amount'] == 0){ echo filter_var($label_language_values['free'], FILTER_SANITIZE_STRING); }else{echo  filter_var($general->ld_price_format($rs['net_amount'], FILTER_SANITIZE_STRING),$symbol_position,$decimal);}?></td>
								<td><?php if($rs['partial_amount'] == 0){ echo filter_var($label_language_values['free'], FILTER_SANITIZE_STRING); }else{echo  filter_var($general->ld_price_format($rs['partial_amount'], FILTER_SANITIZE_STRING),$symbol_position,$decimal);}?></td>
							<?php 
							}
							else{
								?>
								...
								<td><?php echo filter_var($rs['payment_status'], FILTER_SANITIZE_STRING);	?>   <a class="btn btn-primary update_payment_status" href="javascript:void(0);" id="update_payment_status" data-status="<?php echo filter_var($rs['payment_status'], FILTER_SANITIZE_STRING);	?>" data-order_id="<?php echo filter_var($rs['order_id'], FILTER_SANITIZE_STRING); ?>"><?php  echo filter_var($label_language_values['update'], FILTER_SANITIZE_STRING); ?></a></td>
								<?php 
		...
		<div id="staff-payments" class="tab-pane fade">
				<h3><?php echo filter_var($label_language_values['staff_payments_details'], FILTER_SANITIZE_STRING);	?></h3>
				<div id="accordion" class="panel-group">
					<form id="" name="" class="" method="post">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="col-md-2 col-sm-2 col-xs-12 col-lg-2">
							<br />
							<button type="button" class="btn btn-info mb-10 get_payment_staff_by_date" name=""><?php echo filter_var($label_language_values['submit'], FILTER_SANITIZE_STRING);	?></button>
						</div>
					</div>	
					<div class="mb-5" id="hr"></div>
					<div class="col-md-12 col-sm-12 col-xs-12">
