...
$first_step->conn=$conn;
	...
	if(!is_numeric(strpos($decrypt_code,'#'))) {
		echo filter_var("Wrong URL", FILTER_SANITIZE_STRING); die;
	}
						...
						<div class="form-container">
							<div class="tab-content">
								<form id="reset_new_passwd" method="post">
									...
									<?php  } 	if($current_time > $url_time){	?>
										<h4 class="txt-danger" style="display:block;"><?php echo filter_var($label_language_values['your_reset_password_link_expired'], FILTER_SANITIZE_STRING);	?></h4>									
									<?php 
										}else{
									?>
									<div class="clearfix"> 
