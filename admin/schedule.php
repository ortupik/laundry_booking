            ...
            <div class="container-fluid tab-content ld-staff-right-details">
                <div class="tab-pane col-lg-12 col-md-12 col-sm-12 col-xs-12 active" id="member-details">
                    ...
                    $option = $objdayweek_avail->get_schedule_type_according_provider($staff_id);
                            ...
                            <tr>
<td><span class="login_user_id" id="login_user_id" data-id="<?php echo filter_var($_SESSION['ld_adminid'], FILTER_SANITIZE_STRING); ?>"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12 ld-weeks-breaks-menu">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    if($minweek==1 && $maxweek==5){
                                        for($i=$minweek;$i<=$maxweek;$i++){
                                            ?>
                                            <li class="<?php if($i==1){ echo filter_var("active", FILTER_SANITIZE_STRING);}?>"><a href="#<?php echo filter_var($breaks_weeknameid[$i-1]."_br", FILTER_SANITIZE_STRING);	?>" data-toggle="tab"><?php echo filter_var($breaks_weeknameid[$i-1], FILTER_SANITIZE_STRING);	?> </a></li>
                                        <?php 
                                        }
                                    }else{
                                        $i=1;
                                        ?>
                                        <li class="<?php if($i==1){ echo filter_var("active", FILTER_SANITIZE_STRING);}?>"><a href="#<?php echo filter_var($breaks_weeknameid[$i-1]."_br", FILTER_SANITIZE_STRING);	?>" data-toggle="tab"><?php echo filter_var($label_language_values['this_week'], FILTER_SANITIZE_STRING);	?></a></li>
                                    <?php 
                                    }
                                    ?>
                                </ul>
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 ld-weeks-breaks-details">
                                <div class="tab-content">
                                    ...
                                    {
                                        ?>
                                        <div class="tab-pane <?php  if($i==1){ echo filter_var("active", FILTER_SANITIZE_STRING);}?>" id="<?php echo filter_var($breaks_weeknameid[$i-1]."_br", FILTER_SANITIZE_STRING);	?>">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <?php  if($minweek==1 && $maxweek==1){ ?>
                                                    ...
                                                    <ul class="list-unstyled" id="ld-staff-breaks">
                                                        ...
                                                        for ($j = 1; $j <= 7; $j++) {
                                                            ...
                                                            <li class="active">
                                                                ...
                                                                {?>
                                                                    <span class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
<a id="ld-add-staff-breaks" data-weekid="<?php echo filter_var($i, FILTER_SANITIZE_STRING);	?>" data-staff_id="<?php echo filter_var($_SESSION['ld_adminid'], FILTER_SANITIZE_STRING); ?>" data-weekday="<?php echo filter_var($j, FILTER_SANITIZE_STRING);	?>"
                        ...
                        <div class="panel-body">
                            <div class="ld-member-offtime-inner">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-12 col-lg-2">
                                    <a href="javascript:void(0)" id="add_break" data-id="<?php echo filter_var($_SESSION['ld_adminid'], FILTER_SANITIZE_STRING);	?>" class="form-group btn btn-info mt-20" name=""><?php echo filter_var($label_language_values['add_break'], FILTER_SANITIZE_STRING);	?></a>
                                </div>
                            </div>
                            <div class="ld-staff-member-offtime-list-main mytablefor_offtimes mt-20 col-md-12 col-xs-12 np">
                                <h3><?php echo filter_var($label_language_values['your_added_off_times'], FILTER_SANITIZE_STRING);	?></h3>
                                ...
                                <div class="pull-left">
                                    <div class="ld-custom-checkbox">
                                        <ul class="ld-checkbox-list">
                                            <li>
                                                <input style="margin:0px;" type="checkbox"  class="fullmonthoff all" data-prov_id="<?php echo filter_var($_SESSION['ld_adminid'], FILTER_SANITIZE_STRING); ?>" id="<?php echo filter_var($year.'-'.$this_month, FILTER_SANITIZE_STRING);	?>" <?php   $offday->off_year_month=$year.'-'.$this_month;
