...
*	set value of insert id while updating record equals to filter_var($_POST['id'], FILTER_SANITIZE_STRING);
...
class laundry_image_upload{
		...
		public function upload_image(){
			if($this->checksize()){
				echo filter_var("Size of image should not be more than 10 MB", FILTER_SANITIZE_STRING);
				exit;
			}
