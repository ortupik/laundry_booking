...
";
  ...
  public function q23(){
		...
		if(@mysqli_num_rows($regadmin)>0) {
			 ...
			 $query1 = "INSERT INTO `ld_admin_info` (`id`, `password`, `email`, `fullname`, `phone`, `address`, `city`, `state`, `zip`, `country`,`role`, `description`, `enable_booking`, `service_commission`, `commision_value`, `schedule_type`, `image`, `service_ids`) VALUES (1, '" . $pass . "','".$this->email."' , '', '', '', '', '', '', '','admin', '', 'N', 'F', '0', 'W', '', '');";
			 mysqli_query($this->conn, $query1);
...
mysqli_query($this->conn, $insert_default_lang_zh_CN);
    ...
    public function q27(){		
		/* new version update */
		$remove_fk_constraints_ld_services_addon = "ALTER TABLE ld_services_addon
DROP FOREIGN KEY services_addon_ibfk_1;";
		$remove_fk_constraints_ld_services_addon_rate = "ALTER TABLE ld_addon_service_rate
DROP FOREIGN KEY addon_service_rate_ibfk_1;";
		$remove_fk_constraints_ld_services_method = "ALTER TABLE ld_services_method
DROP FOREIGN KEY services_method_ibfk_1;";
		$remove_fk_constraints_ld_service_methods_units = "ALTER TABLE ld_service_methods_units
DROP FOREIGN KEY service_methods_units_ibfk_1;";
		$remove_fk_constraints_ld_service_methods_units_2 = "ALTER TABLE ld_service_methods_units
DROP FOREIGN KEY service_methods_units_ibfk_2;";
		$remove_fk_constraints_ld_services_methods_units_rate = "ALTER TABLE ld_services_methods_units_rate
DROP FOREIGN KEY services_methods_units_rate_ibfk_1;";
		$remove_fk_constraints_ld_service_methods_design = "ALTER TABLE ld_service_methods_design
DROP FOREIGN KEY service_methods_design_ibfk_1;";
		mysqli_query($this->conn,$remove_fk_constraints_ld_services_addon);
        mysqli_query($this->conn,$remove_fk_constraints_ld_services_addon_rate);
		mysqli_query($this->conn,$remove_fk_constraints_ld_services_method);
		mysqli_query($this->conn,$remove_fk_constraints_ld_service_methods_units);
        mysqli_query($this->conn,$remove_fk_constraints_ld_service_methods_units_2);
        mysqli_query($this->conn,$remove_fk_constraints_ld_services_methods_units_rate);
        mysqli_query($this->conn,$remove_fk_constraints_ld_service_methods_design);
        ...
        $sms_template_insert = "INSERT INTO `ld_sms_templates` (`id`, `sms_subject`, `sms_message`, `default_message`, `sms_template_status`, `sms_template_type`, `user_type`) VALUES
